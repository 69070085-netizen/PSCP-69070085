...
```text
นับจำนวนสระภาษาอังกฤษ (a, e, i, o, u) ที่ปรากฏในข้อความที่รับเข้ามา โดยนับสระแต่ละตัวแยกกัน และแสดงผลเฉพาะสระที่มีจำนวนมากกว่า 0 ตัวเท่านั้น นอกจากนี้ ต้องไม่สนใจว่าเป็นตัวอักษรพิมพ์เล็กหรือพิมพ์ใหญ่
...
```text
Step 1: รับข้อความเข้ามา แล้วแปลงเป็นตัวพิมพ์เล็กทั้งหมดด้วย .lower()
Step 2: เช็กว่ามีสระ 'a' หรือไม่ (count > 0) ถ้ามีให้พิมพ์ a : จำนวน
Step 3: เช็กว่ามีสระ 'e' หรือไม่ (count > 0) ถ้ามีให้พิมพ์ e : จำนวน
Step 4: เช็กว่ามีสระ 'i' หรือไม่ (count > 0) ถ้ามีให้พิมพ์ i : จำนวน
Step 5: เช็กว่ามีสระ 'o' หรือไม่ (count > 0) ถ้ามีให้พิมพ์ o : จำนวน
Step 6: เช็กว่ามีสระ 'u' หรือไม่ (count > 0) ถ้ามีให้พิมพ์ u : จำนวน
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันแปลงข้อความรับเข้าทั้งหมดให้เป็นตัวพิมพ์เล็กด้วย .lower() จากนั้นใช้ฟังก์ชัน .count() ตรวจสอบและนับจำนวนของสระแต่ละตัว (a, e, i, o, u) แยกทีละตัว หากพบว่าสระตัวไหนมีจำนวนมากกว่า 0 จะแสดงผลสระตัวนั้นพร้อมจำนวนตามรูปแบบที่กำหนด
```
