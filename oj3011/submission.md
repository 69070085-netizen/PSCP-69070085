...
```text
แม่สี (Primary Color) มี 3 สี คือ สีแดง (Red) สีเหลือง (Yellow) และสีน้ำเงิน (Blue)
เอาสีแดง มารวมกับสีเหลือง จะได้สีส้ม (Orange)
เอาสีแดง มารวมกับสีน้ำเงิน จะได้สีม่วง (Violet)
เอาสีเหลือง มารวมกับสีน้ำเงิน จะได้สีเขียว (Green)
ถ้าผสมสี 2 สี จากแม่สีที่ให้มา แล้วตอบว่าได้สีอะไร หากมีสีอื่นที่ไม่ใช่แม่สีมาผสม ให้ตอบว่า Error

Input
2 บรรทัด เป็นชื่อสี

Output
แสดงชื่อสีที่ผสมได้ ถ้าไม่ใช่สีที่เป็นแม่สีแสดง Error
```
...
```text
Step 1:อ่านค่าข้อความชื่อสี 2 บรรทัด (color, color1)
Step 2:ใช้ if-else checkเงื่อนไข เอาแม่สีมาผสมกันว่าได้สีไร แสดงสีที่ผสมได้
Step 3:ถ้าไม่ตรงเงื่อนไข แสดง Error
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ตรวจสอบว่าทั้งสองสีอยู่ในกลุ่มแม่สี (Red, Yellow, Blue) หรือไม่ ถ้าไม่ใช่จะแสดงผล "Error"
```
...
```text
ตรวจสอบกรณีที่แม่สีชนิดเดียวกัน 2 บรรทัด
```
