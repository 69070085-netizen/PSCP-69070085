...
```text
รับ วัน เดือน แล้วบอกฤดู 
Input:
month  จำนวนเต็บบวก
day จำนวนเต็บบวก

Output:
print เป็น winter spring summer fall ฤดูจะเป็นทุกๆวันที่21 เดือนที่หาร 3ลงตัว

Constraints:
เงื่อนไขใน if-elif-else ต้องดูเงื่อนไขดีๆ
```
...
```text
Step 1: อ่านค่าเดือน (month) และวัน (day) ที่เป็นจำนวนเต็มจากผู้ใช้
Step 2: เช็กช่วงของวันเริ่มต้นฤดูกาลตามจุดเปลี่ยนฤดู (วันที่ 21 ของเดือน 3,6,9,12)
Step 3: ถ้าวันไม่ถึงจุดเปลี่ยนฤดู ให้ตรวจสอบช่วงเดือนที่เหลือ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้เงื่อนไข if-elif ตรวจสอบวันที่เริ่มต้นของฤดูกาลใหม่ก่อน (วันที่ 21 ของเดือน 3, 6, 9 และ 12) เพื่อกำหนดฤดู spring, summer, fall และ winter ตามลำดับ จากนั้นใช้ elif ไล่เช็กเงื่อนไขเดือนจากน้อยไปมากเพื่อเก็บตกช่วงวันที่เหลือก่อนถึงวันเปลี่ยนฤดู
```
