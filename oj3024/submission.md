...
```text
ผลการโหวตจากกรรมการ 3 คน  Surprising หรือไม่ โดยการโหวตนี้มีกรรมการ 3 คน 

Input:
รับค่าคะแนนรวม มาเป็นจำนวนจริง
รับค่าคะแนนสูงสุด มาเป็นจำนวนจริง

Output:
พิมพ์ Surprising ถ้าความแตกต่างระหว่างคะแนนสูงสุดกับคะแนนต่ำสุดมากกว่า 2
พิมพ์ Not surprising ในกรณีอื่น ๆ ความแตกต่างน้อยกว่าหรือเท่ากับ 2

Constraints:
ดูช่วงคะแนน คะแนนที่เหลือต้องไม่เกิน คะแนนสูงสุด รับค่าเป็นfloat ดูเงื่อนไขดีๆ
```
...
```text
Step 1: รับค่า totalscore และค่า highscore เป็น float
Step 2: หาคะแนนรวมของกรรมการอีก 2 คนที่เหลือ โดยนำ totalscore ลบด้วย highscore
Step 3: ลองแจกแจงคะแนนที่เหลือให้คนแรกก่อน โดยถ้าคะแนนที่เหลือมากกว่าหรือเท่ากับ highscore ให้คนแรกได้เท่ากับ highscore แล้วที่เหลือค่อยยกให้คนสุดท้าย
Step 4: แต่ถ้าคะแนนที่เหลือน้อยกว่า highscore ให้คนแรกรับคะแนนที่เหลือไปทั้งหมด แล้วคนสุดท้ายได้ 0
Step 5: ตรวจสอบว่าความต่างระหว่างhighscor กับ last มากกว่า 2 มั้ย
Step 6: ถ้ามากกว่า 2 ให้แสดงผล "Surprising" ถ้าไม่มากกว่าให้แสดงผล "Not surprising"

สิ่งที่ฉันคิดไว้ตอนแรก: ฉันพยายามหาคะแนนที่ต่ำที่สุดที่เป็นไปได้ด้วยการยัดคะแนนให้คนกลางได้มากที่สุดก่อน เพื่อให้คนสุดท้ายได้คะแนนน้อยที่สุดเท่าที่จะเป็นไปได้ แต่ยังไม่แน่ใจว่ากรณีที่คะแนนรวมลบด้วย highscore แล้วเกิน highscore ไปเยอะๆ การกระจายคะแนนแบบนี้จะครอบคลุมทุกเคสมั้ย
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก พราะจาก Logic การแจกคะแนนนี้ เป็นการพยายามดันคะแนนของคนที่สองให้สูงที่สุดเท่าที่จะทำได้ เพื่อบีบให้คนที่สาม (last) ได้คะแนนต่ำที่สุดเท่าที่เป็นไปได้ ซึ่งเพียงพอต่อการนำมาตรวจหาเงื่อนไขความต่างเกิน 2 คะแนนตามที่โจทย์ต้องการ
```
