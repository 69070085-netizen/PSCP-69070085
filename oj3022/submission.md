...
```text
แปลงหน่วยอุณหภูมิ โดยรับค่าอุณหภูมิเริ่มต้น หน่วยเดิม และหน่วยที่ต้องการแปลงไปและแสดงผลลัพธ์เป็นทศนิยม 2 ตำแหน่ง

Input:
ค่าอุณหภูมิtemp รับเป็นจำนวนจริง float
หน่วยอุณหภูมิก่อนแปลง before C F K R
หน่วยอุณหภูมิหลังแปลง after C F K R

Output:
ค่าอุณหภูมิหลังแปลงหน่วยเรียบร้อยแล้ว ทศนิยท 2 ตำแหน่ง

Constraints:
เรื่องหน่วยของอุณหภูมิ  ง่ายๆก้ต้องแปลงเป็น C แล้วค่อนแปลงไปเป็น ที่เราต้องการ
```
...
```text
Step 1 :ค่าอุณหภูมิtemp รับเป็นจำนวนจริง float
             หน่วยอุณหภูมิก่อนแปลง before C F K R
             หน่วยอุณหภูมิหลังแปลง after C F K R
Step 2: แปลงอุณหภูมิจากหน่วยเริ่มต้น (before) ให้กลายเป็นหน่วย celsius ก่อน เพื่อใช้เป็นหน่วยกลาง
Step 3: นำค่า celsius ที่ได้ ไปแปลงเป็นหน่วยปลายทาง (after) ที่ต้องการ
แสดงผลลัพธ์ last โดยจัดฟอร์แมตให้เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แปลงหน่วยอุณหภูมิเริ่มต้น (before) ให้กลายเป็นหน่วยเซลเซียส (celsius) ก่อน เพื่อใช้เป็นอุณหภูมิฐานกลาง จากนั้นจึงนำค่าเซลเซียสที่ได้ไปแปลงเป็นหน่วยปลายทาง (after) ที่ต้องการ และแสดงผลเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
กรณีแปลงจากหน่วยเดิมไปหน่วยเดิม
```
