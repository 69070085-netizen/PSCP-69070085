...
```text
โจทย์ให้ฉันรับข้อความภาษาอังกฤษที่มีความยาว 5 ตัวอักษร แล้วทำการสลับตำแหน่งตัวอักษรจากหลังมาหน้า (กลับด้านข้อความ) พร้อมทั้งเปลี่ยนตัวอักษรทั้งหมดให้เป็นตัวพิมพ์เล็ก

Input:
โปรแกรมรับข้อความตัวอักษรภาษาอังกฤษ ความยาว 5 ตัวอักษร

Output:
โปรแกรมแสดงผลข้อความที่ถูกกลับด้าน (จากหลังมาหน้า) และแปลงเป็นตัวพิมพ์เล็กทั้งหมด

Constraints:
ข้อความที่รับเข้ามาต้องมีความยาว 5 ตัวอักษรพอดี และผลลัพธ์สุดท้ายจะต้องเป็นตัวพิมพ์เล็กเท่านั้น ไม่ว่า Input จะมีตัวพิมพ์ใหญ่ออกมาหรือไม่
```
...
```text
Step 1: อ่านค่าข้อความภาษาอังกฤษความยาว 5 ตัวอักษร (word)
Step 2: สลับตำแหน่งตัวอักษรโดยกลับด้านจากหลังมาหน้า
Step 3: แปลงข้อความที่กลับด้านแล้วให้เป็นตัวพิมพ์เล็กทั้งหมด
Step 4: พิมพ์ข้อความผลลัพธ์ออกทางหน้าจอ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันรับข้อความเข้ามาแล้วใช้ String Slicing [::-1] เพื่อสลับตำแหน่งอักษรจากหลังมาหน้า ร่วมกับเมธอด .lower() เพื่อแปลงเป็นตัวพิมพ์เล็กทั้งหมดในบรรทัดเดียวผ่าน word[::-1].lower() แล้วพิมพ์ผลลัพธ์ออกทางหน้าจอ
```
